...
export function updateSession(id: string, patch: Partial<Pick<AgentSession, 'status' | 'providerSessionId' | 'permissionMode' | 'codexSandboxMode' | 'codexReasoningEffort' | 'model' | 'usage' | 'codexUsage'>>): AgentSession | undefined {
