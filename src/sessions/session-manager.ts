...
export function updateSession(id: string, patch: Partial<Pick<AgentSession, 'status' | 'providerSessionId' | 'permissionMode' | 'codexSandboxMode' | 'codexReasoningEffort' | 'codexWebSearchMode' | 'codexWebSearchEnabled' | 'model' | 'usage' | 'codexUsage'>>): AgentSession | undefined {
