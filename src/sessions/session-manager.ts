...
export function updateSession(id: string, patch: Partial<Pick<AgentSession, 'status' | 'providerSessionId' | 'permissionMode' | 'claudeDeniedTools' | 'codexSandboxMode' | 'codexReasoningEffort' | 'codexWebSearchMode' | 'codexWebSearchEnabled' | 'codexAdditionalDirectories' | 'model' | 'usage' | 'codexUsage'>>): AgentSession | undefined {
