...
export function updateSession(id: string, patch: Partial<Pick<AgentSession, 'status' | 'providerSessionId' | 'permissionMode' | 'codexSandboxMode' | 'model' | 'usage' | 'codexUsage'>>): AgentSession | undefined {
